...
const nextConfig = {
  images: {
    ...
    domains: ["localhost", "127.0.0.1", "0.0.0.0", "162.19.228.222", "keyzonestates.com", "www.keyzonestates.com", "crm.keyzonestates.com", "api.keyzonestates.com", "umami.keyzonestates.com"],
    remotePatterns: [
      ...
      { protocol: "https", hostname: "umami.keyzonestates.com", port: "", pathname: "/**" },
